...
async def setup():
    ...
    await bot.send_file(LOG , "./userbot/others/setup.jpg" , caption="• UserBot And AssistantBot Has Been Start Now!"" , buttons=[[Button.url("• Support •", url="https://t.me/MrAbolii")]])
