...
def Captcha():
    new = Image.new('RGBA', (370, 250), (random.randint(50, 200), random.randint(50, 200), random.randint(50, 200)))
    pimages = []
    emoji_names = []
    ...
    position = [(20, 20), (100, 20), (180, 20), (260, 20), (20, 100), (100, 100), (180, 100), (260, 100), (20, 180), (100, 180), (180, 180), (260, 180)]
