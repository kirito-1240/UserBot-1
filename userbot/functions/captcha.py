...
def MakeCaptcha():
    new = Image.new('RGB', (600, 460), (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)))
    ...
    position = [(20, 20), (180, 20), (310, 20), (20, 160), (180, 160), (310, 160), (20, 300), (180, 300), (310, 300)]
